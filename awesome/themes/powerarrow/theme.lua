...
--{{ For the volume icon }} --
theme.mute = theme.dir .. "/icons/volmute.png"
theme.volhi = theme.dir .. "/icons/volhi.png"
theme.volmed = theme.dir .. "/icons/volmed.png"
theme.vollow = theme.dir .. "/icons/vollow.png"
...
'<span background="#4B3B51" font="UbuntuMono 12"><span font="xos4 Terminus 9" color="#EEEEEE"> Vol:$1 </span></span>', 0.3, "Master")
...
vicious.register(volumeicon, vicious.widgets.volume, function(widget, args)
    ...
    if args[2] == "♩" or paraone == 0 then
        ...
        volumeicon:set_image(theme.mute)
    elseif paraone >= 67 and paraone <= 100 then
        -- volume is high
        volumeicon:set_image(theme.volhi)
    elseif paraone >= 33 and paraone <= 66 then
        -- volume is medium
        volumeicon:set_image(theme.volmed)
    else
        -- volume is low
...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            -- wibox.container.background(wibox.container.margin(wibox.widget { mpdicon, theme.mpd.widget1, layout = wibox.layout.align.horizontal }, dpi(3), dpi(6)), theme.bg_focus),
            arrow(theme.bg_normal, "#4B3B51"),
            wibox.container.background(wibox.container.margin(wibox.widget { volumeicon, volume, layout = wibox.layout.align.horizontal }), "#4B3B51"),
            arrow("#4B3B51", "#777E76"),
